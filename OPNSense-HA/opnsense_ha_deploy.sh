...
touch "$LOG_FILE" 2>/dev/null || LOG_FILE="opnsense.log"
echo "Logging to $LOG_FILE"

# Validate required variables exist
required_vars=("token" "region" "linode_type" "memory" "network_id" "subnet_CIDR" "virtualdisk" "StackScriptID" "active" "standby")
    ...
    create_disk1=$(cat <<EOF
{
  ...
  "stackscript_data": $stackscript_json
}
EOF
) 
